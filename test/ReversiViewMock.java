...
/**
 * Mock of reversi view in a reversi game. Used to mock view and reveal functionality.
 **/
public class ReversiViewMock extends JFrame implements ReversiView {
   ...
   */
  public ReversiViewMock(ReadOnlyReversi model) {
